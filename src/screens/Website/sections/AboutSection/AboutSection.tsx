...
export const AboutSection = (): JSX.Element => {
  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-screen gap-2.5 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-[140px] py-16 md:py-20 lg:py-24 w-full">
      <Card ref={ref} className={`flex items-start justify-center gap-2 p-[38px] w-full bg-black rounded-[32px] shadow-[14px_22px_58px_#fa6d231f,57px_89px_106px_#fa6d231a,127px_201px_143px_#fa6d230f,226px_357px_169px_#fa6d2305,354px_558px_185px_transparent] border-0 transition-all duration-700 ease-out ${
        ...
        <CardContent className="flex flex-col lg:flex-row items-start gap-2 p-0 w-full">
          <div className="flex flex-col items-start gap-[26px] flex-1">
            ...
            <Button className="inline-flex items-center justify-center gap-2.5 px-[18px] py-3 bg-[#fa6b24] rounded-lg hover:bg-[#fa6b24]/90 h-auto transition-all duration-300 hover:scale-105 hover:shadow-[0_0_20px_rgba(250,107,36,0.5)]">
                ...
                {terminalCommands.map((cmd, index) => {
                  ...
                  return (
                    <div key={index} className={`relative w-full h-[26px] transition-opacity duration-300 ${
                      ...
                      <div
                        className={`absolute top-0 left-8 [font-family:'Source_Code_Pro',Helvetica] text-[20.8px] tracking-[0] leading-[normal]`}
                      >
